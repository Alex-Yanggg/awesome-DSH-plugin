...
- [tabbit-browser](https://github.com/Tabbit-Browser/dsh-tabbit) — 通过 tabbit-cli 让 DeepSeek Harness 智能体驱动真实的 Tabbit 浏览器，用于网页自动化、信息抽取、QA 与基准测试，内置技能并提供按地区分发的安装器工具。
