...
- [dsh-whale-meter](https://github.com/Shiye-10Pages/dsh-whale-meter) — DSH 用量账本：按本月 token 消耗评 🐟→🐳 五档段位，分位本地估算并附可分享战绩卡；6 家厂商 46 个模型精准计价，含国内厂商按输入长度分档；回填安装前的会话；8·17 调价前后各按各价。
