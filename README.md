...
- [dsh-trace-compare](https://github.com/lamost423/dsh-trace-compare) — Agent trajectory visualization: the main path, failed detours, backtracks, and subagent branches on one wall-clock timeline, with two-log same-axis comparison and a live per-session maze tab.
